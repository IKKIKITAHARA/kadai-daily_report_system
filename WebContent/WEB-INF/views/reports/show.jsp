  ...
  <c:param name="content">
    <c:choose>
      <c:when test="${report != null}">
        ...
        <table>
          <tbody>
            ...
            <tr>
              <th>内容</th>
              <td>
              <pre><c:out value="${report.content}" /></pre></td>
            </tr>
            <tr>
              <th>登録日時</th>
        ...
        <!-- 自分の日報の場合（ログインしたIDと日報のIDが同じ）、editへリンク -->
    ...
    <a href ="<c:url value="/reports/like?likeaction=${report.id}" />">いいね！</a>
    </c:when>
    <c:otherwise>イイネ済み！</c:otherwise>
    </c:choose>
     </p>
